...
//		System.out.println();
//		knn("classification\\glass_train.txt","classification\\glass_test.txt", 1, 1);
//		knn("classification\\glass_train.txt","classification\\glass_test.txt", 2, 1);
//		knn("classification\\glass_train.txt","classification\\glass_test.txt", 3, 1);
//		knn("classification\\glass_train.txt","classification\\glass_test.txt", 4, 1);
//		System.out.println();
//		knn("classification\\glass_train.txt","classification\\glass_test.txt", 1, 2);
//		knn("classification\\glass_train.txt","classification\\glass_test.txt", 2, 2);
//		knn("classification\\glass_train.txt","classification\\glass_test.txt", 3, 2);
//		knn("classification\\glass_train.txt","classification\\glass_test.txt", 4, 2);
